...
const [loading, setLoading] = useState(false);
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#eef3ff] via-[#f7f9ff] to-[#edf2ff] flex items-center justify-center">
  ...
  >
    ...
    <div className="relative flex-1 flex items-center justify-center px-6 sm:px-10 lg:px-16 py-10 h-full">
      ...
      <div className="relative z-10 w-full max-w-xl">
        ...
        <div className="flex justify-center items-center mt-[25px] mb-5">
          <span>
            If you don't have a account then contact your admin
          </span>
        </div>
